  ...
  return (
    <section className="about-container">
      ...
      <p className="about-p">
        ...
        take-away, where the taste of home knows no borders. <br />
        <br />
        Sincerely,
        <br />
        Li and Kim
      ...
      <p className="about-p">
        ...
        <br />
        We take pride in curating a menu where locally sourced ingredients take
        center stage. From farm to plate, we support local producers, ensuring a
        burst of freshness in every bite. We're not just crafting dishes; we're
        ...
        sauce without compromise. <br />
        <br />
        In a world where choices matter, we are proud to declare our commitment
        to being GMO-free. Our dishes are crafted with care, free from
        genetically modified organisms, ensuring your dining experience is a
        celebration of purity and taste. Join us in this culinary journey where
        every dish tells a tale of tradition, love, and a dedication to
        providing a memorable experience for every guest.
      </p>
    </section>
  );
};
