  ...
  return (
    <motion.article layout className="contact-form">
      <AnimatePresence mode="wait">
        {formSubmitted ? (
          <motion.div layout>
            <motion.h3 layout>Tack för ditt meddelande!</motion.h3>
            <motion.p layout>
              Ditt meddelande har skickats. <br /> Vi svarar inom 24 timmar.
            </motion.p>
          ...
          <motion.div
            ...
            layout
          >
            <motion.h3 layout>Ett enkelt formulär för snabba svar!</motion.h3>
            <motion.p layout>
            ...
            <motion.button onClick={handleSubmit} className="button blue">
              Skicka
            </motion.button>
          </motion.div>
        )}
